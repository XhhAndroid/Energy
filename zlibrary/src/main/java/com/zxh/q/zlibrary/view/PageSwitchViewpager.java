 ...
 */
public class PageSwitchViewpager extends ViewPager {
    public static final String TAG = "PageSwitchViewpager";

    private boolean mEnabled = true;
    private boolean mFadeEnabled = false;
    private boolean mOutlineEnabled = false;
    public static int sOutlineColor = 0;
    ...
    public PageSwitchViewpager(Context context) {
        this(context, null);
    }
    ...
    public PageSwitchViewpager(Context context, AttributeSet attrs) {
        super(context, attrs);
        sOutlineColor = context.getResources().getColor(R.color.theme_color);
